...
public class AccessOrderedList<V> implements Iterable<V>{
	...
	/**
	 * merges the surrounding nodes together, effectively popping this one out of the list
	 */
	...
	private class AccessOrderedListIterator<K> implements Iterator<K>
	{
		...
		/**
		 * 
		 * @param accessOrderedList the order list at which to start our iterator
		 */
