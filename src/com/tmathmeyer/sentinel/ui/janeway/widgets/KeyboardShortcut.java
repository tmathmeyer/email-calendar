...
/**
 * This class performs the given action when a keyboard event is received that
 * matches the keyboard shortcut this class represents.
 *
 */
public class KeyboardShortcut
{
	...
	/**
	 * A KeyStroke representing the combination of keys required for this
	 * shortcut
	 */
	 ...
	 * 
	 * @param keyStroke a KeyStroke representing the combination of keys that
	 *            make up this shortcut
	 */
	...
	/**
	 * Adds the given action to the list of actions to perform when this
	 * KeyboardShortcut is pressed
	 * 
	...
	/**
	 * Removes the given action from the list of actions to perform when this
	 * KeyboardShortcut is pressed
	 * 
