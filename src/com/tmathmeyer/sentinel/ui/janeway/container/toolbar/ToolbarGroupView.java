...
import com.tmathmeyer.sentinel.ui.janeway.widgets.Hoverable;

/**
 * Holds a view for a group of controls on the toolbar. The group has a name,
 * which is displayed in a label on the bottom, and content, which is displayed
 * above. Clients should make sure to set preferred/minimum/maximum sizes
 * appropriately in order to best fit their contents.
 */
...
public class ToolbarGroupView extends JPanel implements Hoverable
{
	...
	public ToolbarGroupView(String name)
	{
		...
		setMaximumSize(new Dimension(1, Integer.MAX_VALUE)); // don't stretch
															 // horizontally
	...
	/**
	 * @return The JPanel holding the content of this group - controls should be
	 *         added in here
	 */
