...
/**
 * Provides a default view for a toolbar and methods for adding/removing
 * ToolbarGroupViews. The toolbar cannot be dragged, and groups line up along
 * the X axis. Excess space goes to the right. Methods will take care of
 * separators such that there is exactly one between each ToolbarGroupView
 * within the toolbar, assuming no outside forces muck with the toolbar
 * contents.
 */
...
public class DefaultToolbarView extends JToolBar
{
	...
	/**
	 * Insert a ToolbarGroupView into the toolbar at the specified index. If the
	 * group is already at the specified index, nothing happens. If the group is
	 * already in the toolbar but at the wrong index, a RuntimeException is
	 * thrown since the index value becomes meaningless after the existing group
	 * is removed.
	 * 
	...
	/**
	 * Add a ToolbarGroupView to the end of the toolbar if it isn't already on
	 * the toolbar.
	 * 
